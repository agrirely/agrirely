        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-5 grid items-center gap-5 sm:mt-6 sm:gap-6 lg:mt-7 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
            <div className="animate-fade-up delay-1 max-w-2xl">
              <p className="mt-0 text-sm leading-relaxed text-muted sm:text-base">
                {hero.description}
              </p>

              <ul className="mt-5 flex flex-wrap items-center gap-x-0 gap-y-2 border-t border-line pt-4 sm:mt-6 sm:pt-5">
                {audienceSignals.map((signal, index) => (
                  <li key={signal} className="flex items-center">
                    ...
                    <span className="text-[11px] font-semibold uppercase tracking-[0.16em] text-brand-deep sm:text-xs">
                      {signal}
                    </span>
                  </li>
                ))}
